function InteractionsList({ interactions, loading, onRefresh }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-slate-200 dark:border-slate-700">
      <div className="bg-gradient-to-r from-slate-800 to-slate-700 dark:from-slate-900 dark:to-slate-800 p-5">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onRefresh}
            disabled={loading}
            className="bg-emerald-500 dark:bg-emerald-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-emerald-600 dark:hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl flex items-center space-x-2"
          >
      ...
      <div className="overflow-x-auto">
        {loading && interactions.length === 0 ? (
          <div className="p-12 text-center">
            <div className="inline-block animate-spin rounded-full h-10 w-10 border-b-2 border-emerald-500 dark:border-emerald-400"></div>
                ...
                <tr key={interaction._id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 dark:from-emerald-500 dark:to-teal-600 flex items-center justify-center shadow-md">
